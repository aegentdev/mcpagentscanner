...
# 1. Harden against prompt injection by sanitizing user-provided text.
# 2. This function should be applied to any user input before it is included in an LLM prompt.
# 3. import re
#
